...
import com.websyndic.front.Pages.Subscribe;
 
public class ValidateSubscribeFunctionality {
    ...
    ExtentTest test;
    String testname = "UserCanSubscribeToQuestion";
    ...
    public void validateQuestionCreateFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("UserCanSubscribeToQuestion", "Validate subscribe functionality");
    		...
    		subscribe.clickUnSubscribeButton();
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "User can subscribe to a question");
