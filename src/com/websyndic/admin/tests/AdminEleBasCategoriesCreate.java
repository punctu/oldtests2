...
public class AdminEleBasCategoriesCreate {
    ...
    ExtentTest test;
    String testname = "AdminEleBasCategoriesCreate";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminEleBasCategoriesCreate", "Admin can create new category");
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create new category");
