...
public class AdminCreateArticle {
    ...
    ExtentTest test;
    String testname = "AdminCreateArticle";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminCreateArticle", "Admin can create a new article");
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create a new article");
