...
public class AdminEleBasAuteurCreate {
    ...
    ExtentTest test;
    String testname = "AdminEleBasAuteurCreate";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminEleBasAuteurCreate", "Admin can add a new auteur");
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can add a new auteur");
