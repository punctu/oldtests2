...
public class AdminQuestionCommentApprove {
    ...
    ExtentTest test;
    String testname = "AdminQuestionCommentApprove";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminQuestionCommentApprove", "Admin can approve a question comment");
...
//            
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can approve a question comment");
