...
public class AdminEleBasTagsCreate {
    ...
    ExtentTest test;
    String testname = "AdminEleBasTagsCreate";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminEleBasTagsCreate", "Admin can create new tags");
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create new tags");
