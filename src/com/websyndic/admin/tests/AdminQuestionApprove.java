...
public class AdminQuestionApprove {
    ...
    ExtentTest test;
    String testname = "AdminQuestionApprove";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminQuestionApprove", "Admin can approve a question");
...
//            
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can approve a question");
