...
public class AdminQuestionCommentCreate {
    ...
    ExtentTest test;
    String testname = "AdminQuestionCommentCreate";
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("AdminQuestionCommentCreate", "Admin can add a new comment to a question");
...
//            
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can add a new comment to a question");
