...
public class AdminEcommerceCreateCupons {
    ...
    ExtentTest test;
    String testname = "AdminEcommerceCreateCupons";
    ...
    @Test
    public void addNewCupon() throws IOException {
        try {
        	// Start test. Mention test script name
            test = reports.startTest("AdminEcommerceCreateCupon", "Admin can create a new cupon");
...
//    		
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create a new cupon");
