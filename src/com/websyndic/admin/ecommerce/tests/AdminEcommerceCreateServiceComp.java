...
public class AdminEcommerceCreateServiceComp {
    ...
    public void addNewService() throws IOException {
        try {
            ...
            test = reports.startTest("AdminEcommerceCreateServiceComp", "Admin can create a new ServiceComp");
...
//    		
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create a new servicecomp");
