...
public class FrontUserCanAddProductToCart {
    ...
    @Test
    public void frontUserCanAddProductToCart() throws IOException {
        try {
        	// Start test. Mention test script name
            test = reports.startTest("FrontUserCanAddProductToCart", "User can ad product to cart");
...
//    		
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "User can add product to cart");
