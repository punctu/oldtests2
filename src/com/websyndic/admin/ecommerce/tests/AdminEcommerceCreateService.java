...
public class AdminEcommerceCreateService {
    ...
    ExtentTest test;
    String testname = "AdminEcommerceCreateService";
    ...
    public void addNewService() throws IOException {
        try {
            ...
            test = reports.startTest("AdminEcommerceCreateService", "Admin can create a new service");
...
//    		assertTrue(isTextPresent("a été créé avec succès."));
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create a new service");
