...
public class AdminEcommerceCreateBox {
    ...
    ExtentTest test;
    String testname = "AdminEcommerceCreateBox";
    ...
    @Test
    public void addNewBox() throws IOException {
        try {
        	// Start test. Mention test script name
            test = reports.startTest("AdminEcommerceCreateBox", "Admin can create a new box");
...
//    		assertTrue(isTextPresent("a été créé avec succès."));
            ...
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "Admin can create a new box");
