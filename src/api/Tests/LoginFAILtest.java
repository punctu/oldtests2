...
public class LoginFAILtest {
    ...
    public void validateLoginFunctionality() throws IOException {
        try {
            ...
            test = reports.startTest("UserCanLogin", "Validate login functionality");
            ...
            assertTrue(localStorage.contains("LOGIN FAIL"));
            
            // Print log info in HTML report
            TestNGThread.sleep(1000);
            test.log(LogStatus.INFO, "User 'm.plique@cotoit.fr' can login");
